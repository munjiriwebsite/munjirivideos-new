  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        behindthescenesvideographysouthafrica: path.resolve(__dirname, 'blog/behind-the-scenes-videography-south-africa/index.html'),
        ...
        howtoeditvideosforsocialmedia: path.resolve(__dirname, 'blog/how-to-edit-videos-for-social-media/index.html'),
        ...
        commonmistakessocialmediavideoproduction: path.resolve(__dirname, 'blog/common-mistakes-social-media-video-production/index.html'),
        socialmediavideoideas: path.resolve(__dirname, 'blog/social-media-video-ideas/index.html'),
        thebestwaytouploadvideoonyoutube: path.resolve(__dirname, 'blog/the-best-way-to-upload-video-on-youtube/index.html'),
        videostorytelling: path.resolve(__dirname, 'blog/video-storytelling/index.html'),
