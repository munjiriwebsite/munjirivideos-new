  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        behindthescenesvideographysouthafrica: path.resolve(__dirname, 'behind-the-scenes-videography-south-africa.html'),
        ...
        howtoeditvideosforsocialmedia: path.resolve(__dirname, 'how-to-edit-videos-for-social-media.html'),
        ...
        productvideographer: path.resolve(__dirname, 'product-videographer.html'),
        questionstoaskavideographerportugal: path.resolve(__dirname, 'questions-to-ask-a-videographer-portugal.html'),
        ...
        videostorytelling: path.resolve(__dirname, 'video-storytelling.html'),
        ...
        wheretofindfreelancevideographersnearme: path.resolve(__dirname, 'where-to-find-freelance-videographers-near-me.html'),
