  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        filminginlisbon: path.resolve(__dirname, "blog/lisbon-filming-locations/index.html"),
        filmingpermitslisbon: path.resolve(__dirname, "blog/film-permits-lisbon/index.html"),
